...
These steps will generate all of the figures and results from the mansucript. The rendered `simChef` documentation can be found in the `results/` directory (see [here](results/Results.html)).
