...
4. Run each of the simulations in the `meals/` directory (see `job_scripts/driver_simulations.sh`).
5. Reproduce all of the figures from the manuscript by running `notebooks/paper_figures.Rmd`.
