...
![](../causalDT/reference/figures/cdt_diagram.png)
...
Given the pre-treatment covariates data $`X`$, the treatment variable
$`Z`$, and the response variable $`Y`$, we can run CDT as follows:
...
![](reference/figures/README-causalDT-1.png)
...
![](reference/figures/README-jaccard-1.png)
